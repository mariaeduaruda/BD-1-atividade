...
INSERT INTO Consumidor(ID_User, nome, cpf, endereco)
VALUES
...
INSERT INTO Restaurante(ID_Restaurante, nome, tipo_categoria, horario_funcionamento, telefone, endereco)
VALUES
...
INSERT INTO Proprietario(ID_User, ID_Restaurante, nome, cnpj,)
VALUES 
...
VALUES 
(5138864788338633,'Felipe','27/11/2028', 4),
(6363687530809625,'miguel','22/12/2030', 5);
(4828724553368397,'Roberto','03/03/2025', 6),
(6595377270855695,'Sandro','21/04/2029', 7);
...
VALUES 
(1, 1, 2, 20,90,'05/10/16 - 11:51', 'Cartão', 'Avenida Desembargador Moreira'),
(2, 2, 2, 27,99,'09/11/20 - 13:20', 'Dinheiro' ,'Rua da Imprensa'),
(3, 3, 4, 54,50,'03/12/17 - 18:57', 'Cartão', 'Rua das Fiandeiras'),
(4, 4, 6, 20,90,'05/11/96 - 11:51', 'Cartão', 'Avenida Desembargador Moreira'),
(5, 5, 7, 27,99,'09/10/20 - 14:20', 'Dinheiro' ,'Rua da Imprensa'),
(6, 6, 8, 54,50,'03/08/17 - 10:57', 'Cartão', 'Rua das Fiandeiras'),
(7, 7, 6, 20,90,'05/09/19 - 16:51', 'Cartão', 'Avenida Desembargador Moreira'),
(8, 8, 9, 27,99,'09/01/20 - 12:20', 'Cartão' ,'Rua da Imprensa'),
